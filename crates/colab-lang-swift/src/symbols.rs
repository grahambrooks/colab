...
const RENAME_KINDS: &[&str] = &["simple_identifier", "type_identifier"];
...
impl fmt::Display for SymbolRename {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        write!(f, "swift::symbol \"{}\" -> \"{}\"", self.from, self.to)
    }
}
...
mod tests {
    ...
    const SRC: &str = "class Old { func m() -> Old { return Old() } }\n";
